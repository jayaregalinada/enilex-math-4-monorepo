...
describe('MascotUnicorn', () => {
  ...
  it('renders differently for cheer and sad moods', () => {
    const cheer = render(<MascotUnicorn mood="cheer" />);
    const cheerHtml = cheer.container.innerHTML;
    cheer.unmount();

    const sad = render(<MascotUnicorn mood="sad" />);
